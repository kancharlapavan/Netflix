...
df1 = spark.read.csv('D:/Netflix/raw_credits.csv', header=True, inferSchema=True)
...
#Creating temp view
spark.read.option("header",True).csv('D:/Netflix/raw_credits.csv').createOrReplaceTempView("credits")
spark.read.option("header",True).csv('D:/Netflix/raw_titles.csv').createOrReplaceTempView("titles")
...
credits_df = spark.read.option("header", True).csv('D:/Netflix/raw_credits.csv')
titles_df = spark.read.option("header", True).csv('D:/Netflix/raw_titles.csv')
